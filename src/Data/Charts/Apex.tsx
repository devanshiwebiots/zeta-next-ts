...
export const ApexColumnChartSone: ApexOptions = {
  chart: {
    height: 350,
    type: "bar",
    toolbar: {
...
export const Apex3DBubbleCharts: ApexOptions = {
  chart: {
    height: 350,
    type: "bubble",
    toolbar: {
  ...
  colors: ["#6362e7", "#ffc500", "#51bb25", "#7a15f7"],
};

export const ApexStepLineChart: ApexOptions = {
  chart: {
    type: "line",
    height: 350,
    toolbar: {
...
export const ApexPieChart: ApexOptions = {
  chart: {
    width: 380,
    type: "pie",
  },
  ...
  colors: ["#6362e7", "#ffc500", "#51bb25", "#7a15f7", "#ff5f24"],
};

export const ApexDonutCharts: ApexOptions = {
  chart: {
    height: 500,
    width: 380,
    type: "donut",
...
export const ApexMixedCharts: ApexOptions = {
  chart: {
    height: 350,
    type: "line",
    stacked: false,
...
export const ApexCandleStickCharts: ApexOptions = {
  chart: {
    height: 350,
    type: "candlestick",
    toolbar: {
...
export const ApexRadialBarChart: ApexOptions = {
  chart: {
    height: 350,
    type: "radialBar",
  },
...
export const ApexRadarPolygonFillCharts: ApexOptions = {
  chart: {
    height: 350,
    type: "radar",
    toolbar: {
