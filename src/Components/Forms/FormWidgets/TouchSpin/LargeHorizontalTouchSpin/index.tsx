...
import { LargeHorizontalTouchspinSubHeading } from "@/Data/Forms/FormWidgets";
...
const LargeHorizontalTouchspin = () => {
  ...
  return (
    <Col sm="12" md="6">
      <Card>
        <CommonCardHeader heading="Large Horizontal Touchspin" subHeading={LargeHorizontalTouchspinSubHeading} />
        <CardBody>
