...
import { InitialValueTouchspinSubHeading } from "@/Data/Forms/FormWidgets";
...
const InitialValueTouchspin = () => {
  ...
  return (
    <Col sm="12" md="6">
      <Card>
        <CommonCardHeader heading="Touchspin With Initial Value" subHeading={InitialValueTouchspinSubHeading} />
        <CardBody>
