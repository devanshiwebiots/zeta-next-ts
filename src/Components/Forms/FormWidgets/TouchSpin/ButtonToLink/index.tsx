...
import { ButtonClassToLinkSubHeading } from "@/Data/Forms/FormWidgets";
import { ChangeEvent, useState } from "react";
import { Button, Card, CardBody, Col, Input, InputGroup } from "reactstrap";

const ButtonClassToLink = () => {
  ...
  return (
    <Col sm="12" md="6">
      <Card>
        <CommonCardHeader heading="Change Button Class To Link" subHeading={ButtonClassToLinkSubHeading} />
        <CardBody>
...
export default ButtonClassToLink;
