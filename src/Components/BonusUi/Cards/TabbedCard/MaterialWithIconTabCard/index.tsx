...
import { Contact, HomeText, Href, MaterialTabWithIcon, Profile } from "@/Constant";
    ...
    <>
      {TabCardData.map((item, i) => (
        <Col lg="12 " xl="6" className="box-col-12 xl-100" key={i}>
          <Card>
            <CommonCardHeader heading={MaterialTabWithIcon} />
            <CardBody className="pt-0">
              <div className="tabbed-card">
                <Nav className="pull-right border-tabs">
                  <NavItem>
...
export default MaterialWithIcon;
