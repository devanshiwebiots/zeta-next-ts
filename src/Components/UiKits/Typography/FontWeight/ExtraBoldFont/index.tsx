...
import { ExtraBold900, Heading1, Heading2, Heading3, Heading4, Heading5, Heading6 } from "@/Constant";
...
const ExtraBoldFont = () => {
  return (
    <Col sm="6" xl="4">
      <Card>
        <CommonCardHeader heading={ExtraBold900} />
